...
const signUpOrProfile = this.props.loggedIn? (   <Link class="icon-link-splash" to={'/profile'} > <i class="fas fa-user icon-splash icon-fill">  <FontAwesomeIcon className="fai" icon={faUser} /><span className="profile-splash"> Profile </span></i> </Link>):
  (this.props.sign);
...
return (
    ...
    <header className="icon-container-splash">
        ...
        <div className="header-div header-div-1">
           <Link className="icon-link-splash" to={"/covid"}> <i className="fas fa-home icon-splash icon-fill"> <Icon className="first-aid-sp" icon={firstAidLight} /><span className="covid-corner"> Covid  Corner </span> </i></Link>
        </div>
     
        
        <div className="header-div">
         <Link className="icon-link-splash" to={"/newsfeed"}>  <i class="fas fa-newspaper icon-splash icon-fill"><FontAwesomeIcon  icon={faNewspaper} /><span className="news-splash"> Newsfeed </span> </i> </Link>                
        </div>
