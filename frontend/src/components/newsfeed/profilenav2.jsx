...
return (
    ...
    <header className="icon-container">
         ...
         <Link className="icon-link" to={"/covid"}>  <i class="fas fa-newspaper icon icon-fill"><span className="covid-corner cc-news"> Covid  Corner </span> <Icon className="first-aid-sp newsfeed-aid" icon={firstAidLight} /> </i> </Link>                
