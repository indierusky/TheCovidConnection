        ...
        const display = (
            <div className="favor-create-form">
                ...
                <form id={"favor-form"}>
                    ...
                    <label>
                        <textarea className="text-form" type='text' placeholder="Description" value={this.state.favor_description} onChange={this.handleInput('favor_description')} />
                    </label>
                    <br/>
                    <button className="favor-form-button"  disabled={!this.state.favor_title} onClick={this.handleSubmit}>Create Favor</button>
                    </div>
                </form>
            </div>
        )
